...
def orientation_show_result(img, result, class_names, score_thr=0.3, out_file=None):
    """Visualize the detection results on the image.
    ...
    img = mmcv.imread(img)
    if isinstance(result, tuple):
        bbox_result, segm_result, orientation_result = result
    else:
        bbox_result, segm_result, orientation_result = result, None, None
    ...
    mmcv.orientation_imshow_det_bboxes(
        img.copy(),
        bboxes,
        labels,
        ori_bboxes,
