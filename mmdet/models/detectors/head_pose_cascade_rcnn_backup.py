...
class HeadPoseCascadeRCNN(BaseDetector, RPNTestMixin):
    ...
    def __init__(self,
        ...
        super(HeadPoseCascadeRCNN, self).__init__()

        print("This is a modified Cascade RCNN")
        ...
        if orientation_head is not None:
            if not isinstance(bbox_roi_extractor, list):
                self.orientation_bbox_roi_extractor = builder.build_roi_extractor(bbox_roi_extractor)
            else:
                self.orientation_bbox_roi_extractor = builder.build_roi_extractor(bbox_roi_extractor[0])
    ...
    def init_weights(self, pretrained=None):
        super(HeadPoseCascadeRCNN, self).init_weights(pretrained)
