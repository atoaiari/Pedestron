...
from mmdet.apis import inference_detector, init_detector, show_result, orientation_lab_show_result
...
def mock_detector(model, image_name, output_dir):
    ...
    orientation_lab_show_result(image, results, model.CLASSES, out_file=result_name)
